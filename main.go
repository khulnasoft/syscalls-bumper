...
func init() {
	libsRepoRoot = flag.String("repo-root", "https://raw.githubusercontent.com/khulnasoft/libs/master", "khulnasoft/libs repo root (supports http too)")
...
var ia32TranslatorMap = map[int64]int64{
	 ...
	 * (only exit event is actually compatible, see https://github.com/khulnasoft/libs/blob/master/driver/event_table.c#L444
	 */
	22: 166,
}
...
/*
 * This file was automatically created by syscalls-bumper (https://github.com/khulnasoft/syscalls-bumper).")
